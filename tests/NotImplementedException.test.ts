...
import { NotImplementedException } from "../mod.ts";
...
import type { NotImplementedExceptionInit } from "../mod.ts";
//  #endregion
...
import {
  ...
  initCases,
  messageCases,
} from "./_fixtures/NotImplementedException.cases.ts";
//  #endregion

//  #region tests
@TestSuite("NotImplementedException")
class NotImplementedExceptionTest {
  ...
  @TestCase(...initCases)
  @TrackFailedCase
  public testWithInit([data, exMsg]: [NotImplementedExceptionInit, string]) {
  ...
  @Test("(message, init)")
  @TestCase(...allCases)
  public testAll([data, exMsg]: [NotImplementedExceptionInit, string]) {
    const dataEncoded = encodeURIComponent(JSON.stringify(data));
...
Testing(NotImplementedExceptionTest);
